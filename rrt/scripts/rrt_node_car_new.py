...
class RRT(Node):
    def __init__(self):
        ...
        self.marker3_pub_ = self.create_publisher(Marker,'/sample_map', 1)
        ...
        self.global_waypoints = np.genfromtxt('/home/team5/f1tenth_ws/src/HMPC/waypoints/race3_waypoints.csv', delimiter=',')
        self.global_waypoints = self.global_waypoints[:, 0 : 2]     

        self.base_to_lidar = 0.27275    # m
        # self.base_to_lidar = 0.32376
    ...
    def init_occupancy_grid(self):
        ...
        self.occupancy_grid.header.frame_id = "base_link"
    ...
    def pose_callback(self, pose_msg):
        ...
        for iter in range(self.max_rrt_iterations):
            ...
            # debugging
            # p_grid = self.display_marker("ego_racecar/laser_model", 0.0, 1.0, 0.0, [sample_x_grid, sample_y_grid])
            # p_map = self.display_marker("map", 0.0, 0.0, 1.0, [sampled_point[0], sampled_point[1]])
