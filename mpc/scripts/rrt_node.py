...
class RRT(Node):
    def __init__(self):
        ...
        self.marker1_pub_ = self.create_publisher(Marker,'/visualization_marker1', 1)
        self.marker2_pub_ = self.create_publisher(Marker,'/visualization_marker2', 1)
        ...
        self.global_waypoints = np.genfromtxt('/sim_ws/src/lab7/f1tenth_lab7/waypoints/waypoints_levine_old.csv', delimiter=',')
        ...
        self.steer_range = 0.5          # m``
        self.goal_tolerance = 0.2       # m
        self.collision_checking_points = 10
        ...
        # sampling parameters
        self.sample_bias = 0.8
        self.std_deviation = 0.5

        # pure pursuit parameters
        self.clamp_angle = 20.0         # deg
    ...
    def init_occupancy_grid(self):
        ...
        data = np.full((rows, cols), 0, np.int8)
    ...
    def is_occupied(self, x_grid, y_grid):
        ...
        if (self.occupancy_grid.data[og_index] == 100):
            return True
        else:
            return False
    ...
    def pose_callback(self, pose_msg):
        ...
        for iter in range(self.max_rrt_iterations):
            ...
            if ((self.is_occupied(sampled_point[0], sampled_point[1]))):
                continue
            # debugging
            ...
            # p_map = self.display_marker("map", 1.0, 0.0, 0.0, [sampled_point[0], sampled_point[1]])
            # self.marker1_pub_.publish(p_map)
    ...
    def track_path(self, path):
        ...
        # debugging
        p_map = self.display_marker("map", 0.0, 1.0, 0.0, [avg_target_map[0], avg_target_map[1]])
